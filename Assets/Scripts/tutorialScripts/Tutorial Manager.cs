...
public class TutorialManager : MonoBehaviour
{
    ...
    {
        if (lastTutorialIndex == levelIndex) return;
        ...
        switch (levelIndex)
        {
            ...
            case 3:
                tutorialText.text = "You can pick up and move weapons by pressing the 'E' key. The weapon doesn't shoot when it is being held.";
    ...
    public void NextLevel()
    {
        ...
        int levelIndex = TutorialLevelHandler.GetCurrentLevelIndex();
        TutorialLevelHandler.ProceedToNextLevel();
        continueButton.gameObject.SetActive(false);
    }
